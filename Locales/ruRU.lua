...
L["hideTutorialFrames"] = "Прятать подсказки"
L["hideTutorialFramesdesc"] = "Прятать все всплывающие подсказки если это возможно"
...
L["Arrow X-Offset"] = "Смещение по x"
L["Arrow Y-Offset"] = "Смещение по y"
...
L["Chat Bubbles"] = "Облачки сообщений"
...
L["Display player zodiac name."] = "Отображать название созвездия."
...
L["Enable/Disable the minimap. |cffFF0000Warning: This will prevent you from seeing the consolidated buffs bar, and prevent you from seeing the minimap datatexts.|r"] = 'Включить/выключить миникарту. |cffFF0000ВНИМАНИЕ: Отключив карту, вы более не сможете видеть полосу объединенных эффектов и информационные тексты, привязанные к миникарте.|r'
...
L["Enemy NPC Frames"] = "Фреймы вражеских NPC"
L["Enemy Player Frames"] = "Фреймы вражеских игроков"
L["Enemy"] = "Враг"
...
L["Fade Chat Toggles"] = "Исчезновение переключателей чата"
...
L["Zodiac name"] = "Название созвездия"
...
L["Hide In Keystone"] = "Скрыть в Ключах"
...
L["Replaces microbar icons with DF icons."] = "Заменяет иконки микро меню иконками с ДФ"
...
L["stillOnCombatText"] = "Включить всплывающий текст урона"
L["stillOnCombatTextdesc"] = "Включает текст урона даже если стоит режим тонких границ"
...
L["YELL"] = "Крик"
L["Map Markers"] = "Маркеры на карте"
L["Map Markers on map"] = "Включить"
L["Reseive Raid Markers from raid"] = "Получать маркеры от рейда"
